...
public class MongoQuery implements Component {
    ...
    public Entity getConfig() {
        ...
        String Configform = "{ \"form\":[ { \"type\":\"section\", \"htmlClass\":\"row\", \"items\":[ { \"type\":\"section\", \"htmlClass\":\"col-md-6\", \"items\":[\"name\" ] }, { \"type\":\"section\", \"htmlClass\":\"col-md-6\", \"items\":[ \"password\" ] } ] },{ \"type\":\"section\", \"htmlClass\":\"row\", \"items\":[ { \"type\":\"section\", \"htmlClass\":\"col-md-6\", \"items\":[\"database\" ] }, { \"type\":\"section\", \"htmlClass\":\"col-md-6\", \"items\":[ \"collection\" ] } ] }, \"url\", { \"key\":\"query\", \"type\":\"textarea\", \"placeholder\":\"db.collectionName.operation()\", \"onChange\": \"function(modelValue,form) { try{ balanced.matches({source: modelValue, open: ['{', '(', '['], close: ['}', ')', ']'], balance: true, exceptions: true}); document.getElementById('query').style.borderColor='green'; } catch (error) {errorMessage = error.message;console.log(error.message); document.getElementById('query').style.borderColor='red'; } }\" }, { \"type\":\"section\", \"htmlClass\":\"row\", \"items\":[ { \"type\":\"section\", \"htmlClass\":\"col-md-6\", \"items\":[ { \"type\": \"submit\", \"style\": \"btn-info text-right\", \"title\": \"Save\" } ] }, { \"type\":\"section\", \"htmlClass\":\"col-md-6\", \"items\":[ { \"type\": \"button\", \"style\": \"btn-info testConBtn text-left\", \"title\": \"Test\", \"onClick\": \"function(modelValue,form){           }\" } ] } ] }, { \"key\":\"output\", \"type:\":\"textarea\", \"readonly\":true }], \"schema\":{ \"type\": \"object\", \"title\": \"MongoReader\", \"properties\": { \"name\": { \"title\": \"Username\", \"type\": \"string\" }, \"password\": { \"title\": \"Password\", \"type\": \"string\" }, \"database\": { \"title\": \"Database Name\", \"type\": \"string\" }, \"collection\": { \"title\": \"Collection Name\", \"type\": \"string\" }, \"url\": { \"title\": \"Sever URL\", \"type\": \"string\" }, \"query\": { \"title\":\"Query\", \"type\":\"string\" }, \"output\": { \"title\":\"Output\", \"type\":\"string\" } }, \"required\": [\"name\", \"password\", \"collection\", \"database\", \"url\"] }}";
